 ...
 $(document).ready(function() {
   ...
   $(".switch-item").click(function() {
     ...
     var cls = ".switch-block_" + num;
     $(".switch-block").each(function() {
       $(".switch-block").removeClass("switch-block_active");
     });
     $(".switch-item").each(function() {
       $(".switch-item").removeClass("switch-item_active");
     });
     $(this).addClass("switch-item_active");
     $(cls).addClass("switch-block_active");
     return false;
   })
  ...
  $(document).on("click", ".fancy-close", function(event){
   ...
   $('.b-product-tiles-wrap__holder').each(function() {
     if ($(this).find('.b-product-tiles-wrap__measure').width() > $(this).width()) {
      $(this).find('.b-product-tiles__mask').show();
     }
     else {
      $(this).find('.b-product-tiles__mask').hide();
     }
   });
   ...
   $( window ).resize(function() {
     $('.b-product-tiles-wrap__holder').each(function() {
       if ($(this).find('.b-product-tiles-wrap__measure').width() > $(this).width()) {
        $(this).find('.b-product-tiles__mask').fadeIn();
       }
       else {
        $(this).find('.b-product-tiles__mask').fadeOut();
       }
     });
   });

   $('.b-product-list-wrap').each(function() {
     if ($(this).find('.b-product-list-measure').height() > 1000) {
      $(this).css('height','1000px');
      $(this).find('.b-see-more-list').show();
     }
     else {
      $(this).css('height','auto');
      $(this).find('.b-see-more-list').hide();
     }
   });
  ...
  $( window ).resize(function() {
   ...
   $(".b-hint-size-popup-link").click(function() {
     $.fancybox.open({
       href: '#b-hint-size-popup',
       padding: 0,
       minWidth: 940,
       minHeight: 580,
       scrolling: 'no',
   ...
   $(".b-hint-type-popup-link").click(function() {
     $.fancybox.open({
       href: '#b-hint-type-popup',
       padding: 0,
       minWidth: 1100,
       minHeight: 1320,
       scrolling: 'no',
